...
(function () {
   ...
   FT("formatting_link",
      "[link&formatting&formatting-link [][link foo][link&formatting&formatting-link ]]][string&formatting&formatting-link-string (][string https://example.com/][string&formatting&formatting-link-string )]");
   ...
   FT("formatting_linkReference",
      ...
      "[link&formatting&formatting-link [][link bar][link&formatting&formatting-link ]]:] [string https://example.com/]");
   ...
   MT("linkTitle",
      "[link [[foo]]][string (https://example.com/ \"bar\")] hello");

   // Inline link without title
   MT("linkNoTitle",
      "[link [[foo]]][string (https://example.com/)] bar");

   // Inline link with image
   MT("linkImage",
      "[link [[][tag ![[foo]]][string (https://example.com/)][link ]]][string (https://example.com/)] bar");

   // Inline link with Em
   MT("linkEm",
      "[link [[][link&em *foo*][link ]]][string (https://example.com/)] bar");

   // Inline link with Strong
   MT("linkStrong",
      "[link [[][link&strong **foo**][link ]]][string (https://example.com/)] bar");

   // Inline link with EmStrong
   MT("linkEmStrong",
      "[link [[][link&strong **][link&em&strong *foo**][link&em *][link ]]][string (https://example.com/)] bar");

   // Image with title
   MT("imageTitle",
      "[tag ![[foo]]][string (https://example.com/ \"bar\")] hello");

   // Image without title
   MT("imageNoTitle",
      "[tag ![[foo]]][string (https://example.com/)] bar");
   ...
   MT("labelNoTitle",
      "[link [[foo]]:] [string https://example.com/]");

   MT("labelIndented",
      "   [link [[foo]]:] [string https://example.com/]");

   MT("labelSpaceTitle",
      "[link [[foo bar]]:] [string https://example.com/ \"hello\"]");

   MT("labelDoubleTitle",
      "[link [[foo bar]]:] [string https://example.com/ \"hello\"] \"world\"");
