...
#  visit https://creativecommons.org/licenses/by/3.0/ or send a letter to
...
#    https://phpthumb.sourceforge.net], and are used with written permission
#  from James Heinrich.
#    - GD2BMPstring
#      - GetPixelColor
#      - LittleEndian2String
...
#  [https://www.kingsquare.nl/phppsdreader]
#
#
#
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
	...
	# Author:     Ryan Rud (https://adryrun.com)
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
	...
	# Ref:    https://www.les-stooges.org/pascal/webdesign/vignettes/index.php?la=en
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
	...
	# Ref:      https://blog.peterhaza.no/working-with-image-meta-data-in-exif-and-iptc-headers-from-php/
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
	...
	//https://xmpphptoolkit.sourceforge.net/
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
	...
	# Param in:
	# Param out:
	# Reference:  https://php.net/manual/en/function.imagettftext.php
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
	...
	# Param out:
	# Reference:  https://www.php.net/manual/en/image.examples-watermark.php
	...
	# Ref:      https://www.php.net/manual/en/function.imagefilter.php#82162
	# Notes:      png only
	#
	{
	...
	#
	{
		...
		if (! file_exists($file) && ! $this->checkStringStartsWith('https://', $file) && ! $this->checkStringStartsWith('https://', $file)) {
			if ($this->debug) {
				throw new Exception('Image not found.');
			} else {
				throw new Exception();
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
	...
	# Reference:  https://us3.php.net/manual/en/function.imagecreate.php#53879
	...
	#
	{
		...
		while ($Y >= 0) {
           ...
           * =================
           *
           * Ref: https://us3.php.net/manual/en/function.imagecreate.php#81604
           *
           * Notes:
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
	...
	# Param out:  Return a resource like the other ImageCreateFrom functions
	# Reference:  https://www.kingsquare.nl/phppsdreader
	# Notes:
	#
	{
