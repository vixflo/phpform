(function ($) {
  ...
  class Timepicker extends Component {
    ...
    static _createSVGEl(name) {
      let svgNS = 'https://www.w3.org/2000/svg';
    ...
    _pickerSetup() {
      let $clearBtn = $(
        `<button class="btn-flat timepicker-clear waves-effect" style="visibility: hidden;" type="button" tabindex="${this.options.twelveHour ? '3' : '1'
