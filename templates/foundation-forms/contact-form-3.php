...
$form->addOption('subject', 'Other', 'Other', '', 'data-icon=fi-asterisk prepend ');
...
$form->addBtn('submit', 'submit-btn', 1, 'Send <i class="fi-mail append" aria-hidden="true"></i>', 'class=button primary large, data-ladda-button=true, data-style=zoom-in');
$form->endFieldset();
$form->addHtml('<p class="">* Required fields</p>');
...
<head>
    ...
    <meta name="description" content="Foundation Form Generator - how to create a Contact Form with Rich Text Editor using Php Form Builder">
