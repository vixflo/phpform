...
$form = new Form('contact-form-popover-mp', 'horizontal', 'class=, novalidate', 'foundation');
...
$form_2 = new Form('join-us-popover-form-mp', 'horizontal', 'class=, novalidate', 'foundation');
$form_2->setMode('development');

$form_2->setCols(0, 12);

$form_2->startFieldset('Join Us Form', '', 'class=h4 text-center');
...
$form_2->addBtn('submit', 'submit-btn', 1, 'Get Access Today<i class="fi-unlock fa-lg append"></i>', 'class=button primary, data-ladda-button=true, data-style=zoom-in');

$form_2->endFieldset();

$form_2->addHtml('<p class="text-right "><small><i class="fi-lock prepend"></i>Your Information is Safe With us!</small></p>');
...
<head>
    ...
    <meta name="description" content="Foundation Form Generator - how to create several popover forms on same page with Php Form Builder">
    ...
    <div class="grid-container" style="min-width:66vw;">
        ...
        <div class="grid-x">
            ...
            <div class="cell">
                ...
                ?>
                <button data-popover-trigger="contact-form-popover-mp" class="button primary text-white large">Contact Us</button>
                <button data-popover-trigger="join-us-popover-form-mp" class="button primary text-white large">Join Us</button>
                <?php
                $form->render();
                $form_2->render();
                ?>
