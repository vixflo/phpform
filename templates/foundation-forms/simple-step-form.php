...
if ($currentStep == 1) {
    ...
    $form->setCols(0, 12);
    $form->centerContent();
    $form->addBtn('submit', 'submit-btn', 1, 'Next <i class="fi-arrow-right append" aria-hidden="true"></i>', 'class=button primary, data-ladda-button=true, data-style=zoom-in');
    ...
    $form->setCols(0, 12);
    $form->centerContent();
    $form->addBtn('submit', 'back-btn', 1, '<i class="fi-arrow-left prepend" aria-hidden="true"></i> Back', 'class=button warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 2, 'Next <i class="fi-arrow-right append" aria-hidden="true"></i>', 'class=button primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    ...
    $form->setCols(0, 12);
    $form->centerContent();
    $form->addBtn('submit', 'back-btn', 2, '<i class="fi-arrow-left prepend" aria-hidden="true"></i> Back', 'class=button warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 3, 'Submit <i class="fi-arrow-right append" aria-hidden="true"></i>', 'class=button primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
}
...
<head>
    ...
    <meta name="description" content="Foundation Form Generator - how to create a simple Step Form with Php Form Builder">
    ...
    <div class="grid-container" style="min-width:66vw;">
        ...
        <div class="grid-x">
            ...
            <div class="cell">
                ...
                ?>
                <h2 class="text-center ">Simple Step Form</h2>
                <?php
                $form->render();
                ?>
            </div>
