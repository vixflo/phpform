...
$form->startFieldset('Validation using Native HTML5 fieldtypes / attributes', '', 'class=h4 text-center');
...
$form->endFieldset();
$form->startFieldset('Validation using Custom HTML5 attributes (data)', '', 'class=h4 text-center');
...
<head>
    ...
    <meta name="description" content="Foundation Form Generator - how to create form with jQuery live validation using Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/foundation-forms/validation-with-javascript-example-form.php" />
        ...
        <div class="grid-x">
            ...
            <div class="cell">
                <div class="text-center">
                    <a href="https://www.phpformbuilder.pro/documentation/class-doc.php#javascript-validation-getting-started" class="btn button secondary small"><strong>Javascript Validation plugin</strong> - documentation here <i class="fi-arrow-right append"></i></a>
                </div>
                <?php
