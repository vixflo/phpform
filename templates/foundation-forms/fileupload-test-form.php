...
$form = new Form('fileupload-test-form', 'horizontal', 'novalidate', 'foundation');
...
$form->startFieldset('Single file upload', '', 'class=h4 text-center');
...
$form->startFieldset('Multiple files upload', '', 'class=h4 text-center');
...
$form->startFieldset('Multiple images upload with resizing, thumbnails and image editor (crop/rotate)', '', 'class=h4 text-center');
...
$form->startFieldset('Prefilled upload with existing image', '', 'class=h4 text-center');
...
$form->startFieldset('Drag and drop', '', 'class=h4 text-center');
...
<head>
    ...
    <title>Foundation File Upload Form - How to create PHP forms easily</title>
    <meta name="description" content="Foundation Form Generator - how to create a File Upload with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/foundation-forms/fileupload-test-form.php" />
        ...
        <div class="grid-x">
            ...
            <div class="cell">
                <div class="text-center">
                    <a href="https://www.phpformbuilder.pro/documentation/javascript-plugins.php#fileuploader" class="btn button secondary small"><strong>File uploader plugin</strong> - documentation here <i class="fi-arrow-right append"></i></a>
                </div>
                <?php
                $form->render();
                ?>
