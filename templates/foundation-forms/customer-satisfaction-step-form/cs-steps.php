...
if ($currentStep == 1) {
    ...
    $form = new Form($formId, 'horizontal', 'data-fv-no-auto-submit=true, novalidate', 'foundation');
    $form->setMode('development');
    $form->addRadio('satisfied-with-company', 'Very Satisfied', 'Very Satisfied', 'data-toggle=true, data-on-icon=fi fi-die-five, data-off-icon=fi fi-x-circle, data-on-color=success-o, data-size=bigger');
    $form->addRadio('satisfied-with-company', 'Somewhat satisfied', 'Somewhat satisfied', 'data-toggle=true, data-on-icon=fi fi-die-four, data-off-icon=fi fi-x-circle, data-on-color=primary-o, data-size=bigger');
    $form->addRadio('satisfied-with-company', 'Neither satisfied nor dissatisfied', 'Neither satisfied nor dissatisfied', 'data-toggle=true, data-on-icon=fi fi-die-three, data-off-icon=fi fi-x-circle, data-on-color=info-o, data-size=bigger, checked');
    $form->addRadio('satisfied-with-company', 'Somewhat dissatisfied', 'Somewhat dissatisfied', 'data-toggle=true, data-on-icon=fi fi-die-two, data-off-icon=fi fi-x-circle, data-on-color=warning-o, data-size=bigger');
    $form->addRadio('satisfied-with-company', 'Very dissatisfied', 'Very dissatisfied', 'data-toggle=true, data-on-icon=fi fi-die-one, data-off-icon=fi fi-x-circle, data-on-color=danger-o, data-size=bigger');
    ...
    $form->centerContent();
    $form->setCols(0, 12, 'sm');
    $form->addBtn('submit', 'submit-btn', 1, 'Next <i class="fi fi-arrow-right ml-2" aria-hidden="true"></i>', 'class=button small primary, data-ladda-button=true, data-style=zoom-in');
    $options = [
        'plain'       => 'plain',
        'size'        => 'bigger',
        'animations'  => 'smooth'
    ...
    $form->centerContent();
    $form->setCols(0, 12, 'sm');
    $form->addBtn('button', 'back-btn', 2, '<i class="fi fi-arrow-left mr-2" aria-hidden="true"></i> Back', 'class=button small warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 2, 'Next <i class="fi fi-arrow-right ml-2" aria-hidden="true"></i>', 'class=button small primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    ...
    $form->centerContent();
    $form->setCols(0, 12, 'sm');
    $form->addBtn('button', 'back-btn', 3, '<i class="fi fi-arrow-left mr-2" aria-hidden="true"></i> Back', 'class=button small warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 3, 'Next <i class="fi fi-arrow-right ml-2" aria-hidden="true"></i>', 'class=button small primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
    ...
    $form->centerContent();
    $form->setCols(0, 12, 'sm');
    $form->addBtn('button', 'back-btn', 4, '<i class="fi fi-arrow-left mr-2" aria-hidden="true"></i> Back', 'class=button small warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 4, 'Next <i class="fi fi-arrow-right ml-2" aria-hidden="true"></i>', 'class=button small primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
    ...
    $form = new Form($formId, 'vertical', 'data-fv-no-auto-submit=true, novalidate', 'foundation');
    $form->setMode('development');
    ...
    $form->centerContent();
    $form->setCols(0, 12, 'sm');
    $form->addBtn('button', 'back-btn', 5, '<i class="fi fi-arrow-left mr-2" aria-hidden="true"></i> Back', 'class=button small warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 5, 'Submit <i class="fi fi-arrow-right ml-2" aria-hidden="true"></i>', 'class=button small primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
