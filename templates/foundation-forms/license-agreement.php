...
$form = new Form('license-agreement-form', 'vertical', 'novalidate', 'foundation');
$form->setMode('development');
$form->startFieldset('Please read the terms and conditions of the license carefully', '', 'class=h4 text-center');

if ($hasSignatureError) {
    $signatureErrorMsg = Form::buildAlert('Please add your signature to confirm your agreement', 'foundation', 'danger');
...
$form->addInput('hidden', 'user-signature', '', 'Sign to confirm your agreement', 'data-signature-pad=true, data-background-color=#F7F7F7, data-pen-color=#333, data-width=100%, data-clear-button=true, data-clear-button-class=button warning, data-clear-button-text=clear');
$form->centerContent();
$form->addRecaptchaV3('6LeNWaQUAAAAAGO_c1ORq2wla-PEFlJruMzyH5L6');
$form->addBtn('submit', 'submit-btn', 1, 'Agree <i class="input-group-label fi-check append" aria-hidden="true"></i>', 'class=button primary, data-ladda-button=true, data-style=zoom-in');
$form->endFieldset();
...
<head>
    ...
    <title>Foundation License agreement Form with digital signature - How to create PHP forms easily</title>
    <meta name="description" content="Foundation Form Generator - how to create a License agreement Form with digital signature with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/foundation-forms/license-agreement.php" />
