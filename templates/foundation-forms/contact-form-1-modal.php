...
$form = new Form('contact-form-1-modal', 'horizontal', 'novalidate', 'foundation');
...
<head>
    ...
    <title>Foundation Modal Contact Form - How to create PHP forms easily</title>
    <meta name="description" content="Foundation Form Generator - how to create a Modal Contact Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/foundation-forms/contact-form-1-modal.php" />
...
<body>
    ...
    <h1 class="text-center">Php Form Builder - Foundation Modal Contact Form</h1>
        ...
        <div class="grid-x">
            ...
            <div class="cell">
                <div class="text-center">
                    <a href="https://www.phpformbuilder.pro/documentation/javascript-plugins.php#modal-example" class="btn button secondary small"><strong>Modal forms</strong> - documentation here <i class="fi-arrow-right append"></i></a>
                </div>
                <?php
                ...
                ?>
                <button data-micromodal-trigger="modal-contact-form-1-modal" class="button primary large">Contact Us</button>
                <?php
                $form->render();
                ?>
            </div>
