...
$form = new Form('sign-up-popover-form-1', 'vertical', 'class=, novalidate', 'foundation');
...
$form->centerContent();
$form->addBtn('submit', 'submit-btn', 1, 'Sign Up <i class="fi-mail append" aria-hidden="true"></i>', 'class=button primary, data-ladda-button=true, data-style=zoom-in');
...
<head>
    ...
    <meta name="description" content="Foundation Form Generator - how to create a Sign Up Popover Form with Php Form Builder">
    ...
    <div class="grid-container" style="min-width:66vw;">
        ...
        <div class="grid-x">
            ...
            <div class="cell">
                ...
                <button type="button" data-popover-trigger="sign-up-popover-form-1" class="button primary text-white large">Sign Up</button>
                <?php
                $form->render();
                ?>
            </div>
