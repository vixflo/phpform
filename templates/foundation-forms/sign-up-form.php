...
if (isset($_POST['back-btn'])) {
    ...
    if (isset($_POST['form-step-1']) && Form::testToken('form-step-1') === true) {
        ...
        $validator->notStartsWith('robot', Form::buildAlert('Sorry I don\' like robots ...', 'foundation', 'danger'))->validate('human-or-robot');
        ...
        if ($validator->hasErrors()) {
            ...
            $currentStep = 1;
            $userMessage = Form::buildAlert('<strong>Wrong informations ! </strong> Please try again ...', 'foundation', 'warning');
...
if ($currentStep == 1) {
    ...
    $form->centerContent();
    $form->addBtn('submit', 'submit-btn', 1, 'Next <i class="input-group-label fi-arrow-right append" aria-hidden="true"></i>', 'class=btn small btn-primary , data-ladda-button=true, data-style=zoom-in');
    ...
    $form->centerContent();
    $form->addBtn('submit', 'back-btn', 1, '<i class="fas fa-arrow-left  prepend" aria-hidden="true"></i> Back', 'class=btn small btn-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 2, 'Next <i class="input-group-label fi-arrow-right append" aria-hidden="true"></i>', 'class=btn small btn-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    ...
    $form->centerContent();
    $form->addBtn('submit', 'back-btn', 2, '<i class="fas fa-arrow-left prepend" aria-hidden="true"></i> Back', 'class=btn small btn-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 3, 'Submit <i class="input-group-label fi-arrow-right  append" aria-hidden="true"></i>', 'class=btn small btn-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
}
...
<head>
    ...
    <meta name="description" content="Foundation Form Generator - how to create a Sign Up Form with Php Form Builder">
