...
$form = new Form('car-rental-form', 'horizontal', 'data-accordion=true,novalidate', 'foundation');
...
$form->centerContent();
$form->addBtn('submit', 'submit-btn', 1, 'Submit', 'class=button primary mt-4');
$form->endFieldset();
...
<head>
    ...
    <title>Foundation Car Rental Form - Step Accordion form</title>
    <meta name="description" content="Foundation Form Generator - how to create a Step Accordion form with Php Form Builder Class">
