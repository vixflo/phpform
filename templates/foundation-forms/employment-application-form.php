...
$form = new Form('employment-application-form', 'horizontal', 'novalidate', 'foundation');
$form->setMode('development');

$form->startFieldset('Your job', '', 'class=h4 text-center');
...
$form->addIcon('salary-requirements', '<i class="input-group-label fi-dollar" aria-hidden="true"></i>', 'after');
$form->addInput('text', 'salary-requirements', '', 'Salary Requirements', 'data-fv-integer');
$form->endFieldset();

// Portfolio
$form->startFieldset('Your Portfolio', '', 'class=h4 text-center');
...
// Contact Information
$form->startFieldset('Your Contact Information', '', 'class=h4 text-center');
$form->setCols(3, 4);
...
$form->centerContent();
$form->addBtn('submit', 'my-btn-5', 1, 'Send <span class="fi-mail append"></span>', 'class=button primary, data-ladda-button=true, data-style=slide-left');
...
<head>
    ...
    <title>Foundation Employment Application Form - How to create PHP forms easily</title>
    <meta name="description" content="Foundation Form Generator - how to create an Employment Application Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/foundation-forms/employment-application-form.php" />
