...
// materialize plugin
$form->addPlugin('materialize', '#email-templates');
...
$form->addBtn('reset', 'reset-btn', 1, 'Reset <i class="fas fa-ban ml-2" aria-hidden="true"></i>', 'class=btn btn-warning waves-effect waves-light', 'my-btn-group');
$form->addBtn('submit', 'submit-btn', 1, 'Send <i class="fas fa-envelope ml-2" aria-hidden="true"></i>', 'class=btn btn-primary waves-effect waves-light, data-ladda-button=true, data-style=zoom-in', 'my-btn-group');
...
<head>
    ...
    <title>Material Bootstrap Form - Sending emails with PHP Form Builder - How to create PHP forms easily</title>
    <meta name="description" content="Material Bootstrap Form Generator - how to send emails with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/material-bootstrap-forms/email-templates.php" />
...
<body>
    ...
    <h1 class="text-center">Php Form Builder - Material Bootstrap Form<br><small>sending emails using HTML/CSS email templates</small></h1>
