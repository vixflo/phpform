...
if (isset($_POST['back-btn'])) {
    ...
    if (isset($_POST['form-step-1']) && Form::testToken('form-step-1') === true) {
        ...
        $validator->notStartsWith('robot', Form::buildAlert('Sorry I don\' like robots ...', 'bs4', 'danger'))->validate('human-or-robot');
        ...
        if ($validator->hasErrors()) {
            ...
            $currentStep = 1;
            $userMessage = Form::buildAlert('<strong>Wrong informations ! </strong> Please try again ...', 'bs4', 'warning');
...
if ($currentStep == 1) {
    ...
    // materialize plugin
    $form->addPlugin('materialize', '#form-step-1');
    ...
    $form->setCols(0, 12);
    $form->centerContent();
    $form->addBtn('submit', 'submit-btn', 1, 'Next <i class="fas fa-arrow-right ml-2" aria-hidden="true"></i>', 'class=btn btn-primary waves-effect waves-light, data-ladda-button=true, data-style=zoom-in');
    ...
    $form->setCols(0, 12);
    $form->centerContent();
    $form->addBtn('submit', 'back-btn', 1, '<i class="fas fa-arrow-left mr-2" aria-hidden="true"></i> Back', 'class=btn btn-warning waves-effect waves-light', 'btns');
    $form->addBtn('submit', 'submit-btn', 2, 'Next <i class="fas fa-arrow-right ml-2" aria-hidden="true"></i>', 'class=btn btn-primary waves-effect waves-light, data-ladda-button=true, data-style=zoom-in', 'btns');
    ...
    $form->setCols(0, 12);
    $form->centerContent();
    $form->addBtn('submit', 'back-btn', 2, '<i class="fas fa-arrow-left mr-2" aria-hidden="true"></i> Back', 'class=btn btn-warning waves-effect waves-light', 'btns');
    $form->addBtn('submit', 'submit-btn', 3, 'Submit <i class="fas fa-arrow-right ml-2" aria-hidden="true"></i>', 'class=btn btn-primary waves-effect waves-light, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
}
...
<head>
    ...
    <title>Material Bootstrap Simple Step Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Bootstrap Form Generator - how to create a simple Step Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/material-bootstrap-forms/simple-step-form.php" />
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-11 col-lg-10">
                ...
                ?>
                <h2 class="center-align mb-5">Simple Step Form</h2>
                <?php
                $form->render();
                ?>
            </div>
