...
// materialize plugin
$form->addPlugin('materialize', '#fileupload-test-form');
...
<head>
    ...
    <title>Material Bootstrap File Upload Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Bootstrap Form Generator - how to create a File Upload with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/material-bootstrap-forms/fileupload-test-form.php" />
