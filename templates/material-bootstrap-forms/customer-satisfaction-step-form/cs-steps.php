...
if ($currentStep == 1) {
    ...
    $form->centerContent();
    $form->addBtn('submit', 'submit-btn', 1, 'Next <i class="fas fa-arrow-alt-circle-right ml-2" aria-hidden="true"></i>', 'class=btn btn-sm btn-primary, data-ladda-button=true, data-style=zoom-in');
    $options = [
        'plain'       => 'plain',
        'size'        => 'bigger',
        'animations'  => 'smooth'
    ...
    $form->centerContent();
    $form->addBtn('button', 'back-btn', 2, '<i class="fas fa-arrow-alt-circle-left mr-2" aria-hidden="true"></i> Back', 'class=btn btn-sm btn-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 2, 'Next <i class="fas fa-arrow-alt-circle-right ml-2" aria-hidden="true"></i>', 'class=btn btn-sm btn-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    ...
    $form->centerContent();
    $form->addBtn('button', 'back-btn', 3, '<i class="fas fa-arrow-alt-circle-left mr-2" aria-hidden="true"></i> Back', 'class=btn btn-sm btn-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 3, 'Next <i class="fas fa-arrow-alt-circle-right ml-2" aria-hidden="true"></i>', 'class=btn btn-sm btn-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
    ...
    $form->centerContent();
    $form->addBtn('button', 'back-btn', 4, '<i class="fas fa-arrow-alt-circle-left mr-2" aria-hidden="true"></i> Back', 'class=btn btn-sm btn-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 4, 'Next <i class="fas fa-arrow-alt-circle-right ml-2" aria-hidden="true"></i>', 'class=btn btn-sm btn-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
    ...
    $form->centerContent();
    $form->addBtn('button', 'back-btn', 5, '<i class="fas fa-arrow-alt-circle-left mr-2" aria-hidden="true"></i> Back', 'class=btn btn-sm btn-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 5, 'Submit <i class="fas fa-arrow-alt-circle-right ml-2" aria-hidden="true"></i>', 'class=btn btn-sm btn-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
