...
<head>
    ...
    <title>Material Bootstrap Modal Contact Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Bootstrap Form Generator - how to create a Modal Contact Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/material-bootstrap-forms/contact-form-1-modal.php" />
...
<body>
    ...
    <h1 class="text-center">Php Form Builder - Material Bootstrap Modal Contact Form</h1>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-11 col-lg-10">
                <div class="text-center mb-5">
                    <a href="https://www.phpformbuilder.pro/documentation/javascript-plugins.php#modal-example" class="btn btn-secondary btn-sm"><strong>Modal forms</strong> - documentation here <i class="fas fa-arrow-right ml-2"></i></a>
                </div>
                <?php
                ...
                ?>
                <button data-micromodal-trigger="modal-contact-form-1-modal" class="btn btn-primary waves-effect waves-light btn-lg">Contact Us</button>
                <?php
                $form->render();
                ?>
            </div>
