...
<head>
    ...
    <title>Material Bootstrap Contact Form loaded with LoadJs - How to create PHP forms easily</title>
    <meta name="description" content="Material Bootstrap Form Generator - how to create a Contact Form with LoadJs and Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/material-bootstrap-forms/contact-form-1-loadjs.php" />
...
<body>
    ...
    <h1 class="text-center">Php Form Builder - Material Bootstrap Horizontal Contact Form<br><small>with icons &amp; placeholders<br>Loaded with LoadJs Library</small></h1>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-11 col-lg-10">
                <div class="text-center mb-5">
                    <a href="https://www.phpformbuilder.pro/documentation/class-doc.php#useLoadJs" class="btn btn-secondary btn-sm"><strong>Async JS loading with LoadJS</strong> - documentation here <i class="fas fa-arrow-right ml-2"></i></a>
                </div>
                <?php
    ...
    <script defer type="text/javascript">
        // loading Fontawesome icons, jQuery & Bootstrap JS with loadJs (core bundle)
        loadjs([
        ...
        loadjs.ready('core', function() {
            console.log('Fontawesome icons, jQuery & Bootstrap JS loaded');
        });
    </script>
