...
$form->centerContent();
$form->addBtn('reset', 'reset-btn', 1, 'Reset', 'class=btn btn-secondary waves-effect waves-light, data-modal-close=modal-target', 'submit-group');
$form->addBtn('submit', 'submit-btn', 1, 'Sign Up <i class="fas fa-envelope ml-2" aria-hidden="true"></i>', 'class=btn btn-primary waves-effect waves-light, data-ladda-button=true, data-style=zoom-in', 'submit-group');
...
<head>
    ...
    <title>Material Bootstrap Sign Up Modal Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Bootstrap Form Generator - how to create a Sign Up Modal Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/material-bootstrap-forms/sign-up-form-modal.php" />
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-11 col-lg-10">
                ...
                ?>
                <button data-micromodal-trigger="modal-sign-up-modal-form-1" class="btn btn-primary waves-effect waves-light btn-lg">Sign Up</button>
                <?php
                $form->render();
                ?>
            </div>
