...
$form->addHtml('<div class="uk-grid uk-flex-right"><div id="ajax-elements-container" class="uk-container uk-flex-right uk-width-1-1"></div></div>');
$form->addHtml('<div class="row"><div class="col-md-2"><p>&nbsp;</p></div>');
$form->addHtml('<div class="col-md-3"><button type="button" class="uk-button uk-button-primary add-element-button"><i class="uk-icon fas fa-plus-circle" aria-hidden="true"></i></button><p>&nbsp;</p></div>');
$form->addHtml('</div>');
...
<head>
    ...
    <title>UIkit Php Form with Ajax dynamic fields - How to create PHP forms easily</title>
    <meta name="description" content="UIkit Form Generator - how to load dynamic fields on the fly with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/uikit-forms/dynamic-fields-form-2.php" />
...
<body>
    ...
    <h1 class="uk-text-center">Php Form Builder - Form with dynamic ajax-loaded fields<br><small>Click "+" or "-" buttons to add or remove fields</small></h1>
