...
$form = new Form('contact-form-1-modal', 'horizontal', 'novalidate', 'uikit');
...
<head>
    ...
    <title>UIkit Modal Contact Form - How to create PHP forms easily</title>
    <meta name="description" content="UIkit Form Generator - how to create a Modal Contact Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/uikit-forms/contact-form-1-modal.php" />
...
<body>
    ...
    <h1 class="uk-text-center">Php Form Builder - UIkit Modal Contact Form</h1>

    <div class="uk-container" style="min-width:70vw;">
        <div class="uk-text-center uk-margin-large-bottom">
            <a href="https://www.phpformbuilder.pro/documentation/javascript-plugins.php#modal-example" class="uk-button uk-button-default uk-button-small"><strong>Modal forms</strong> - documentation here <i class="fas fa-arrow-right uk-margin-left"></i></a>
        </div>
        <?php
        ...
        ?>
        <button data-micromodal-trigger="modal-contact-form-1-modal" class="uk-button uk-button-primary uk-button-large">Contact Us</button>
        <?php
        $form->render();
        ?>
    </div>
