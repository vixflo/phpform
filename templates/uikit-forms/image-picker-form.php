...
$form = new Form('image-picker-form', 'vertical', '', 'uikit');
$form->setMode('development');

// Single image
$form->startFieldset('Single image select', 'class=uk-fieldset', 'class=uk-legend uk-margin-bottom');
for ($i = 0; $i < 10; $i++) {
...
// Multiple select
$form->startFieldset('Multiple select', 'class=uk-fieldset', 'class=uk-legend uk-margin-bottom');
...
$form->startFieldset('Multiple select with limit', 'class=uk-fieldset', 'class=uk-legend uk-margin-bottom');
...
$form->startFieldset('Single image with labels', 'class=uk-fieldset', 'class=uk-legend uk-margin-bottom');
for ($i = 0; $i < 10; $i++) {
...
$form->startFieldset('Single image with grouped options', 'class=uk-fieldset', 'class=uk-legend uk-margin-bottom');
for ($i = 0; $i < 5; $i++) {
...
$form->addBtn('submit', 'submit-btn', 1, 'Submit', 'class=uk-button uk-button-primary', 'btn-group');
...
<head>
    ...
    <title>UIkit Image picker Form - How to create PHP forms easily</title>
    <meta name="description" content="UIkit Form Generator - how to create an Image picker Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/uikit-forms/image-picker-form.php" />
...
<body>
    ...
    <h1 class="uk-text-center">UIkit Image picker Form<br><small>with Image picker plugin</small></h1>

    <div class="uk-container" style="min-width:70vw;">
        <div class="uk-text-center uk-margin-large-bottom">
            <a href="https://www.phpformbuilder.pro/documentation/javascript-plugins.php#image-picker-example" class="uk-button uk-button-default uk-button-small"><strong>Image picker plugin</strong> - documentation here <i class="fas fa-arrow-right uk-margin-left"></i></a>
        </div>
        <?php
