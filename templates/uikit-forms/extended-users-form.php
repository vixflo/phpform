...
$form = new FormExtended('extended-users-form', 'horizontal', 'novalidate', 'uikit');
...
<head>
    ...
    <title>UIkit Extended Users Form - How to create PHP forms easily</title>
    <meta name="description" content="UIkit Form Generator - how to create a complete Users Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/uikit-forms/extended-users-form.php" />
...
<body>
    ...
    <h1 class="uk-text-center">Php Form Builder - Extended Users Form<br><small>Build a complete users form with a very few lines of code</small></h1>
