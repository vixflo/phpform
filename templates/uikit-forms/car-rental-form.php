...
$form = new Form('car-rental-form', 'horizontal', 'data-accordion=true,novalidate', 'uikit');
...
$form->centerContent();
$form->addBtn('submit', 'submit-btn', 1, 'Submit', 'class=uk-button uk-button-primary mt-4');
$form->endFieldset();
...
<head>
    ...
    <title>UIkit Car Rental Form - Step Accordion form</title>
    <meta name="description" content="UIkit Form Generator - how to create a Step Accordion form with Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/uikit-forms/car-rental-form.php" />
...
<body>
    ...
    <h1 class="uk-text-center">Car Rental Form</h1>
