...
$form = new Form('customer-support-form', 'horizontal', 'novalidate', 'uikit');
...
<head>
    ...
    <title>UIkit Customer Support Form - How to create PHP forms easily</title>
    <meta name="description" content="UIkit Form Generator - how to create a Customer Support Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/uikit-forms/customer-support-form.php" />
...
<body>
    ...
    <h1 class="uk-text-center">Php Form Builder - UIkit Customer Support</h1>
