...
$form = new Form('contact-form-1-popover', 'horizontal', 'novalidate', 'uikit');
...
<head>
    ...
    <title>UIkit Popover Contact Form - How to create PHP forms easily</title>
    <meta name="description" content="UIkit Form Generator - how to create a Popover Contact Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/uikit-forms/contact-form-1-popover.php" />
...
<body>
    ...
    <h1 class="uk-text-center">Php Form Builder - UIkit Popover Contact Form</h1>

    <div class="uk-container" style="min-width:70vw;">
        <div class="uk-text-center uk-margin-large-bottom">
            <a href="https://www.phpformbuilder.pro/documentation/javascript-plugins.php#popover-example" class="uk-button uk-button-default uk-button-small"><strong>Popover forms</strong> - documentation here <i class="fas fa-arrow-right uk-margin-left"></i></a>
        </div>
        ...
        $form->render();
        ?>
        <button data-popover-trigger="contact-form-1-popover" class="uk-button uk-button-primary uk-button-large">Contact Us</button>
    </div>
