...
$form = new Form('date-range-picker-form', 'horizontal', 'novalidate', 'uikit');
$form->setMode('development');

// Simple date picker
$form->startFieldset('Simple date picker', '', 'class=uk-margin-bottom');
...
$form->startFieldset('Simple date range picker', '', 'class=uk-margin-bottom');
...
$form->startFieldset('Date range picker with minimum &amp; maximum date', '', 'class=uk-margin-bottom');
...
$form->startFieldset('Change the date format', '', 'class=uk-margin-bottom');
...
// Change the language
$form->startFieldset('Change the language', '', 'class=uk-margin-bottom');
...
$form->startFieldset('Date range with range restricted to minimum 6 days + reset / submit buttons', '', 'class=uk-margin-bottom');
...
$form->startFieldset('Date range in 2 separate fields + formatted dates', '', 'class=uk-margin-bottom');
...
$form->startFieldset('Date range in 2 separate fields + formatted dates + independent pickers + disabled dates', '', 'class=uk-margin-bottom');
...
$form->addBtn('submit', 'submit-btn', 1, 'Submit', 'class=uk-button uk-button-primary');
...
<head>
    ...
    <title>UIkit Date range picker Form - How to create PHP forms easily</title>
    <meta name="description" content="UIkit Form Generator - how to create an Date range picker Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/uikit-forms/date-range-picker-form.php" />
...
<body>
    ...
    <h1 class="uk-text-center">UIkit Date range picker Form<br><small>with the <em>litepicker</em> picker plugin</small></h1>

    <div class="uk-container" style="min-width:70vw;">
        <div class="uk-text-center uk-margin-large-bottom">
            <a href="https://www.phpformbuilder.pro/documentation/javascript-plugins.php#litepicker-example" class="uk-button uk-button-default uk-button-small"><strong>Litepicker plugin</strong> - documentation here <i class="fas fa-arrow-right uk-margin-left"></i></a>
        </div>
        <?php
