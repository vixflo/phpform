...
if ($currentStep == 1) {
    ...
    $form = new Form($formId, 'horizontal', 'data-fv-no-auto-submit=true, novalidate', 'uikit');
    ...
    $form->centerContent();
    $form->addBtn('submit', 'submit-btn', 1, 'Next <i class="fas fa-arrow-alt-circle-right uk-margin-left" aria-hidden="true"></i>', 'class=uk-button uk-button-small uk-button-primary, data-ladda-button=true, data-style=zoom-in');
    $options = [
        'plain'       => 'plain',
        'size'        => 'bigger',
        'animations'  => 'smooth'
    ...
    $form->centerContent();
    $form->addBtn('button', 'back-btn', 2, '<i class="fas fa-arrow-alt-circle-left uk-margin-right" aria-hidden="true"></i> Back', 'class=uk-button uk-button-small uk-button-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 2, 'Next <i class="fas fa-arrow-alt-circle-right uk-margin-left" aria-hidden="true"></i>', 'class=uk-button uk-button-small uk-button-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    ...
    $form->centerContent();
    $form->addBtn('button', 'back-btn', 3, '<i class="fas fa-arrow-alt-circle-left uk-margin-right" aria-hidden="true"></i> Back', 'class=uk-button uk-button-small uk-button-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 3, 'Next <i class="fas fa-arrow-alt-circle-right uk-margin-left" aria-hidden="true"></i>', 'class=uk-button uk-button-small uk-button-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
    ...
    $form->centerContent();
    $form->addBtn('button', 'back-btn', 4, '<i class="fas fa-arrow-alt-circle-left uk-margin-right" aria-hidden="true"></i> Back', 'class=uk-button uk-button-small uk-button-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 4, 'Next <i class="fas fa-arrow-alt-circle-right uk-margin-left" aria-hidden="true"></i>', 'class=uk-button uk-button-small uk-button-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
    ...
    $form = new Form($formId, 'vertical', 'data-fv-no-auto-submit=true, novalidate', 'uikit');
    $form->setMode('development');
    ...
    $form->centerContent();
    $form->addBtn('button', 'back-btn', 5, '<i class="fas fa-arrow-alt-circle-left uk-margin-right" aria-hidden="true"></i> Back', 'class=uk-button uk-button-small uk-button-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 5, 'Submit <i class="fas fa-arrow-alt-circle-right uk-margin-left" aria-hidden="true"></i>', 'class=uk-button uk-button-small uk-button-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
