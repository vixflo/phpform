...
$form = new Form('cs-step-plugins-loader', 'horizontal', 'novalidate', 'uikit');
...
<head>
    ...
    <title>UIkit Customer Satisfaction Step Form - How to create PHP forms easily</title>
    <meta name="description" content="UIkit Form Generator - how to create a Customer Satisfaction Step Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/uikit-forms/customer-satisfaction-step-form.php" />
...
<body>
    ...
    <h1 class="uk-text-center">Php Form Builder - Customer Satisfaction Step Form<br><small>Step Form with Slide Effect</small></h1>
