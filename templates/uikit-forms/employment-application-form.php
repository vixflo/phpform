...
$form = new Form('employment-application-form', 'horizontal', 'novalidate', 'uikit');
$form->setMode('development');

$form->startFieldset('Your job', '', 'class=uk-margin-bottom');
...
$form->addIcon('salary-requirements', '<i class="uk-form-icon fas fa-dollar-sign" aria-hidden="true"></i>', 'after');
$form->addInput('text', 'salary-requirements', '', 'Salary Requirements', 'data-fv-integer');
$form->endFieldset();

// Portfolio
$form->startFieldset('Your Portfolio', '', 'class=uk-margin-bottom');
...
// Contact Information
$form->startFieldset('Your Contact Information', '', 'class=uk-margin-bottom');
$form->setCols(4, 4);
...
$form->centerContent();
$form->addBtn('submit', 'my-btn-5', 1, 'Send <span class="uk-icon fas fa-envelope uk-margin-left"></span>', 'class=uk-button uk-button-primary, data-ladda-button=true, data-style=slide-left');
...
<head>
    ...
    <title>UIkit Employment Application Form - How to create PHP forms easily</title>
    <meta name="description" content="UIkit Form Generator - how to create an Employment Application Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/uikit-forms/employment-application-form.php" />
...
<body>
    ...
    <h1 class="uk-text-center">Php Form Builder - Employment Application Form<br><small>with File uploader &amp; date picker</small></h1>
