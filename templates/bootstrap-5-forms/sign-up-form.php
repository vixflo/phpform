...
if ($currentStep == 1) {
    ...
    $form->centerContent();
    $form->addBtn('submit', 'submit-btn', 1, 'Next <i class="bi bi-arrow-right ms-2" aria-hidden="true"></i>', 'class=btn btn-sm btn-primary mt-5, data-ladda-button=true, data-style=zoom-in');
    ...
    $form->centerContent();
    $form->addBtn('submit', 'back-btn', 1, '<i class="fas fa-arrow-left mt-5 me-2" aria-hidden="true"></i> Back', 'class=btn btn-sm btn-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 2, 'Next <i class="bi bi-arrow-right ms-2" aria-hidden="true"></i>', 'class=btn btn-sm btn-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    ...
    $form->centerContent();
    $form->addBtn('submit', 'back-btn', 2, '<i class="fas fa-arrow-left me-2" aria-hidden="true"></i> Back', 'class=btn btn-sm btn-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 3, 'Submit <i class="bi bi-arrow-right mt-5 ms-2" aria-hidden="true"></i>', 'class=btn btn-sm btn-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
}
...
<head>
    ...
    <title>Bootstrap 5 Sign Up Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 5 Form Generator - how to create a Sign Up Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-5-forms/sign-up-form.php" />
