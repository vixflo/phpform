...
$form = new Form('email-templates', 'vertical', 'novalidate', 'bs5');
$form->setMode('development');
$form->startFieldset('Please fill in this form to contact us', '', 'class=text-center mb-4');
$form->addHtml('<p class="text-warning text-end">All fields are required</p>');
...
<head>
    ...
    <title>Bootstrap 5 Form - Sending emails with PHP Form Builder - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 5 Form Generator - how to send emails with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-5-forms/email-templates.php" />
...
<body>
    ...
    <h1 class="text-center">Php Form Builder - Bootstrap 5 Form<br><small>sending emails using HTML/CSS email templates</small></h1>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-11 col-lg-10">
                <div class="text-center mb-5">
                    <a href="https://www.phpformbuilder.pro/documentation/class-doc.php#sendMail" class="btn btn-secondary btn-sm"><strong>Email sending</strong> - documentation here <i class="bi bi-arrow-right ms-2"></i></a>
                </div>
                <?php
