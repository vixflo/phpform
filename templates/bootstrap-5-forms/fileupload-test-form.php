...
if ($_SERVER['SERVER_NAME'] == 'www.phpformbuilder.pro' && !file_exists($root . '/file-uploads/images/art-creative-metal-creativity.jpg')) {
    ...
    echo $root . '/file-uploads/images/art-creative-metal-creativity.jpg';
}

$form = new Form('fileupload-test-form', 'horizontal', 'novalidate', 'bs5');
...
<head>
    ...
    <title>Bootstrap 5 File Upload Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 5 Form Generator - how to create a File Upload with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-5-forms/fileupload-test-form.php" />
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-11 col-lg-10">
                <div class="text-center mb-5">
                    <a href="https://www.phpformbuilder.pro/documentation/javascript-plugins.php#fileuploader" class="btn btn-secondary btn-sm"><strong>File uploader plugin</strong> - documentation here <i class="bi bi-arrow-right ms-2"></i></a>
                </div>
                <?php
                $form->render();
                ?>
