...
$form = new Form('validation-with-jquery-example-form', 'horizontal', 'novalidate', 'bs5');
$form->setMode('development');

$form->startFieldset('Validation using Native HTML5 fieldtypes / attributes', '', 'class=text-center mb-4');
...
$form->endFieldset();
$form->startFieldset('Validation using Custom HTML5 attributes (data)', '', 'class=text-center mb-4');
...
$form->addBtn('submit', 'submit-btn', 1, 'Send <i class="bi bi-envelope-fill ms-2" aria-hidden="true"></i>', 'class=btn btn-primary, data-ladda-button=true, data-style=zoom-in', 'my-btn-group');
...
<head>
    ...
    <title>Bootstrap 5 Form with jQuery Live Validation - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 5 Form Generator - how to create form with jQuery live validation using Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-5-forms/validation-with-javascript-example-form.php" />
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-11 col-lg-10">
                <div class="text-center mb-5">
                    <a href="https://www.phpformbuilder.pro/documentation/class-doc.php#javascript-validation-getting-started" class="btn btn-secondary btn-sm"><strong>Javascript Validation plugin</strong> - documentation here <i class="bi bi-arrow-right ms-2"></i></a>
                </div>
                <?php
