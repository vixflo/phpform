...
$form = new Form('contact-form-1-popover', 'horizontal', 'novalidate', 'bs5');
...
<head>
    ...
    <title>Bootstrap 5 Popover Contact Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 5 Form Generator - how to create a Popover Contact Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-5-forms/contact-form-1-popover.php" />
...
<body>
    ...
    <h1 class="text-center">Php Form Builder - Bootstrap 5 Popover Contact Form</h1>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-11 col-lg-10">
                <div class="text-center mb-5">
                    <a href="https://www.phpformbuilder.pro/documentation/javascript-plugins.php#popover-example" class="btn btn-secondary btn-sm"><strong>Popover forms</strong> - documentation here <i class="bi bi-arrow-right ms-2"></i></a>
                </div>
                <?php
                ...
                $form->render();
                ?>
                <button data-popover-trigger="contact-form-1-popover" class="btn btn-primary btn-lg">Contact Us</button>
            </div>
        </div>
    </div>
