...
$form = new Form('contact-form-1-modal', 'horizontal', 'novalidate', 'bulma');
...
<head>
    ...
    <title>Bulma Modal Contact Form - How to create PHP forms easily</title>
    <meta name="description" content="Bulma Form Generator - how to create a Modal Contact Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bulma-forms/contact-form-1-modal.php" />
...
<body>
    ...
    <h1 class="has-text-centered is-size-1 mb-6">Php Form Builder - Bulma Modal Contact Form</h1>
            ...
            <div class="columns is-justify-content-center">
                ...
                <div class="column is-11 is-10-widescreen">
                    <div class="has-text-centered mb-6">
                        <a href="https://www.phpformbuilder.pro/documentation/javascript-plugins.php#modal-example" class="button is-dark is-small"><strong>Modal forms</strong> - documentation here <i class="fas fa-arrow-right ml-2"></i></a>
                    </div>
                    <?php
                    ...
                    ?>
                    <button data-micromodal-trigger="modal-contact-form-1-modal" class="button is-primary is-large">Contact Us</button>
                    <?php
                    $form->render();
                    ?>
                </div>
