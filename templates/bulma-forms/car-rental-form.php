...
$form = new Form('car-rental-form', 'horizontal', 'data-accordion=true,novalidate', 'bulma');
...
$form->centerContent();
$form->addBtn('submit', 'submit-btn', 1, 'Submit', 'class=button is-primary mt-4');
$form->endFieldset();
...
<head>
    ...
    <title>Bulma Car Rental Form - Step Accordion form</title>
    <meta name="description" content="Bulma Form Generator - how to create a Step Accordion form with Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bulma-forms/car-rental-form.php" />
...
<body>
    ...
    <h1 class="has-text-centered is-size-1 mb-6">Car Rental Form</h1>
