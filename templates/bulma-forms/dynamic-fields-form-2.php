...
$form = new Form($formId, 'horizontal', 'novalidate', 'bulma');
...
$form->addHtml('<div class="col-md-3"><button type="button" class="button is-primary add-element-button"><i class="fas fa-plus-circle" aria-hidden="true"></i></button><p>&nbsp;</p></div>');
$form->addHtml('</div>');
...
<head>
    ...
    <title>Bulma Php Form with Ajax dynamic fields - How to create PHP forms easily</title>
    <meta name="description" content="Bulma Form Generator - how to load dynamic fields on the fly with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bulma-forms/dynamic-fields-form-2.php" />
...
<body>
    ...
    <h1 class="has-text-centered is-size-1 mb-6">Php Form Builder - Form with dynamic ajax-loaded fields<br><small>Click "+" or "-" buttons to add or remove fields</small></h1>
