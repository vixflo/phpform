...
$form = new Form('sign-up-modal-form-mp', 'vertical', 'novalidate', 'bulma');
...
$form->addBtn('button', 'sign-up-cancel-btn', 1, 'Cancel', 'class=button is-dark, onclick=MicroModal.close(\'modal-sign-up-modal-form-mp\');', 'submit-group');
$form->addBtn('submit', 'sign-up-submit-btn', 1, 'Send <i class="fas fa-envelope ml-2" aria-hidden="true"></i>', 'class=button is-primary, data-ladda-button=true, data-style=zoom-in', 'submit-group');
...
$form_2 = new Form('contact-form-modal-mp', 'horizontal', 'novalidate', 'bulma');
$form_2->setMode('development');

$form_2->startFieldset('Please fill in this form to contact us', '', 'class=pl-3 is-size-4 has-text-centered mb-4');
$form_2->addHtml('<p class="has-text-warning-dark">All fields are required</p>');
...
$form_2->addBtn('reset', 'reset-btn', 1, 'Reset <i class="fas fa-ban" aria-hidden="true"></i>', 'class=button is-warning', 'my-btn-group');
$form_2->addBtn('submit', 'submit-btn', 1, 'Send <i class="fas fa-envelope ml-2" aria-hidden="true"></i>', 'class=button is-primary, data-ladda-button=true, data-style=zoom-in', 'my-btn-group');
...
<head>
    ...
    <title>Bulma Multiple modal forms - How to create PHP forms easily</title>
    <meta name="description" content="Bulma Form Generator - how to create several modal forms on same page with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bulma-forms/multiple-modals.php" />
...
<body>
    ...
    <h1 class="has-text-centered is-size-1 mb-6">Php Form Builder - several Modal Forms on same page<br><small>click to sign up or contact</small></h1>
            ...
            <div class="columns is-justify-content-center">
                ...
                <div class="column is-11 is-10-widescreen">
                    ...
                    <div class="has-text-centered">
                        <button data-micromodal-trigger="modal-sign-up-modal-form-mp" class="button is-primary text-white is-large">Sign Up</button>
                        <button data-micromodal-trigger="modal-contact-form-modal-mp" class="button is-primary text-white is-large">Contact Us</button>
                    </div>
                    <?php
                    $form->render();
                    $form_2->render();
