...
$form = new Form('employment-application-form', 'horizontal', 'novalidate', 'bulma');
$form->setMode('development');

$form->startFieldset('Your job', '', 'class=pl-3 is-size-4 has-text-centered mb-4');
...
// Portfolio
$form->startFieldset('Your Portfolio', '', 'class=pl-3 is-size-4 has-text-centered mb-4');
...
// Contact Information
$form->startFieldset('Your Contact Information', '', 'class=pl-3 is-size-4 has-text-centered mb-4');
$form->setCols(3, 4);
...
$form->centerContent();
$form->addBtn('submit', 'my-btn-5', 1, 'Send <span class="fas fa-envelope ml-2"></span>', 'class=button is-primary, data-ladda-button=true, data-style=slide-left');
...
<head>
    ...
    <title>Bulma Employment Application Form - How to create PHP forms easily</title>
    <meta name="description" content="Bulma Form Generator - how to create an Employment Application Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bulma-forms/employment-application-form.php" />
...
<body>
    ...
    <h1 class="has-text-centered is-size-1 mb-6">Php Form Builder - Employment Application Form<br><small>with File uploader &amp; date picker</small></h1>
