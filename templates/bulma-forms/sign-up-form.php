...
if ($currentStep == 1) {
    ...
    $form->centerContent();
    $form->addBtn('submit', 'submit-btn', 1, 'Next <i class="fas fa-arrow-right ml-2" aria-hidden="true"></i>', 'class=btn is-small btn-primary mt-5, data-ladda-button=true, data-style=zoom-in');
    ...
    $form->centerContent();
    $form->addBtn('submit', 'back-btn', 1, '<i class="fas fa-arrow-left mt-5 mr-2" aria-hidden="true"></i> Back', 'class=btn is-small btn-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 2, 'Next <i class="fas fa-arrow-right ml-2" aria-hidden="true"></i>', 'class=btn is-small btn-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    ...
    $form->centerContent();
    $form->addBtn('submit', 'back-btn', 2, '<i class="fas fa-arrow-left mr-2" aria-hidden="true"></i> Back', 'class=btn is-small btn-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 3, 'Submit <i class="fas fa-arrow-right mt-5 ml-2" aria-hidden="true"></i>', 'class=btn is-small btn-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
}
...
<head>
    ...
    <title>Bulma Sign Up Form - How to create PHP forms easily</title>
    <meta name="description" content="Bulma Form Generator - how to create a Sign Up Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bulma-forms/sign-up-form.php" />
...
<body>
    ...
    <h1 class="has-text-centered is-size-1 mb-6">Php Form Builder - Sign Up Form<br><small>Fill-in this form to sigh up</small></h1>
