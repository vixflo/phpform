...
$form = new Form('license-agreement-form', 'vertical', 'novalidate', 'bulma');
$form->setMode('development');
$form->startFieldset('Please read the terms and conditions of the license carefully', '', 'class=pl-3 is-size-4 has-text-centered mb-4');

if ($hasSignatureError) {
    $signatureErrorMsg = Form::buildAlert('Please add your signature to confirm your agreement', 'bulma', 'danger');
...
$form->addInput('hidden', 'user-signature', '', 'Sign to confirm your agreement', 'data-signature-pad=true, data-background-color=#F7F7F7, data-pen-color=#333, data-width=100%, data-clear-button=true, data-clear-button-class=button is-warning, data-clear-button-text=clear');
$form->centerContent();
$form->addRecaptchaV3('6LeNWaQUAAAAAGO_c1ORq2wla-PEFlJruMzyH5L6');
$form->addBtn('submit', 'submit-btn', 1, 'Agree <i class="fas fa-check ml-2" aria-hidden="true"></i>', 'class=button is-primary, data-ladda-button=true, data-style=zoom-in');
$form->endFieldset();
...
<head>
    ...
    <title>Bulma License agreement Form with digital signature - How to create PHP forms easily</title>
    <meta name="description" content="Bulma Form Generator - how to create a License agreement Form with digital signature with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bulma-forms/license-agreement.php" />
...
<body>
    ...
    <h1 class="has-text-centered is-size-1 mb-6">Php Form Builder - Bulma License agreement Form<br><small>with electronic signature</small></h1>
