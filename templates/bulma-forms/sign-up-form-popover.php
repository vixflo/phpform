...
$form = new Form('sign-up-popover-form-1', 'vertical', 'class=m-4, novalidate', 'bulma');
...
$form->centerContent();
$form->addBtn('submit', 'submit-btn', 1, 'Sign Up <i class="fas fa-envelope ml-2" aria-hidden="true"></i>', 'class=button is-primary, data-ladda-button=true, data-style=zoom-in');
...
<head>
    ...
    <title>Bulma Sign Up Popover Form - How to create PHP forms easily</title>
    <meta name="description" content="Bulma Form Generator - how to create a Sign Up Popover Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bulma-forms/sign-up-form-popover.php" />
...
<body>
    ...
    <h1 class="has-text-centered is-size-1 mb-6">Php Form Builder - Sign Up Popover Form<br><small>click to open Popover</small></h1>
        ...
        <div class="container">
            ...
            <div class="columns is-justify-content-center">
                ...
                <div class="column is-11 is-10-widescreen">
                    ...
                    <button type="button" data-popover-trigger="sign-up-popover-form-1" class="button is-primary text-white is-large">Sign Up</button>
                    <?php
                    $form->render();
                    ?>
                </div>
