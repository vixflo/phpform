...
$form = new Form('order-form', 'vertical', 'novalidate', 'bulma');
$form->setMode('development');

$form->startFieldset('Order Form', '', 'class=pl-3 is-size-4 has-text-centered mb-4');

$form->startRow('mb-4');

$form->startCol(12);
$form->addHeading('Full name', 'label', 'class=label');
$form->endCol();
...
$form->startCol(12);
$form->addHeading('Contact Number', 'label', 'class=label');
$form->endCol();
...
$form->centerContent();
$form->addBtn('submit', 'submit-btn', 1, 'Proceed <i class="fas fa-check ml-2" aria-hidden="true"></i>', 'class=button is-primary, data-ladda-button=true, data-style=zoom-in');
$form->endFieldset();
...
<head>
    ...
    <title>Bulma Order Form - How to create PHP forms easily</title>
    <meta name="description" content="Bulma Form Generator - how to create an Bulma Order Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bulma-forms/order-form.php" />
...
<body>
    ...
    <h1 class="has-text-centered is-size-1 mb-6">Php Form Builder - Order Form<br><small>vertical form with custom rows &amp; columns</small></h1>
