...
$form = new Form('fileupload-test-form', 'horizontal', 'novalidate', 'bulma');
...
$form->startFieldset('Single file upload', '', 'class=pl-3 is-size-4 has-text-centered mb-4');
...
$form->startFieldset('Multiple files upload', '', 'class=pl-3 is-size-4 has-text-centered mb-4');
...
$form->startFieldset('Multiple images upload with resizing, thumbnails and image editor (crop/rotate)', '', 'class=pl-3 is-size-4 has-text-centered mb-4');
...
$form->startFieldset('Prefilled upload with existing image', '', 'class=pl-3 is-size-4 has-text-centered mb-4');
...
$form->startFieldset('Drag and drop', '', 'class=pl-3 is-size-4 has-text-centered mb-4');
...
<head>
    ...
    <title>Bulma File Upload Form - How to create PHP forms easily</title>
    <meta name="description" content="Bulma Form Generator - how to create a File Upload with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bulma-forms/fileupload-test-form.php" />
...
<body>
    ...
    <h1 class="has-text-centered is-size-1 mb-6">Php Form Builder - File Upload Form<br><small>Upload documents or images</small></h1>
            ...
            <div class="columns is-justify-content-center">
                ...
                <div class="column is-11 is-10-widescreen">
                    <div class="has-text-centered mb-6">
                        <a href="https://www.phpformbuilder.pro/documentation/javascript-plugins.php#fileuploader" class="button is-dark is-small"><strong>File uploader plugin</strong> - documentation here <i class="fas fa-arrow-right ml-2"></i></a>
                    </div>
