...
$form->centerContent();
$form->addBtn('button', 'cancel-btn', 1, 'Cancel', 'class=button is-dark, onclick=MicroModal.close(\'modal-ajax-join-us-form-modal\');', 'submit-group');
...
$form->addHtml('<p class="has-text-centered mb-0"><small><i class="fas fa-lock mr-2"></i>Your Information is Safe With us!</small></p>');
