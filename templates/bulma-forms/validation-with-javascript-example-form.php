...
$form = new Form('validation-with-jquery-example-form', 'horizontal', 'novalidate', 'bulma');
$form->setMode('development');

$form->startFieldset('Validation using Native HTML5 fieldtypes / attributes', '', 'class=pl-3 is-size-4 has-text-centered mb-4');
...
$form->endFieldset();
$form->startFieldset('Validation using Custom HTML5 attributes (data)', '', 'class=pl-3 is-size-4 has-text-centered mb-4');
...
<head>
    ...
    <title>Bulma Form with jQuery Live Validation - How to create PHP forms easily</title>
    <meta name="description" content="Bulma Form Generator - how to create form with jQuery live validation using Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bulma-forms/validation-with-javascript-example-form.php" />
...
<body>
    ...
    <h1 class="has-text-centered is-size-1 mb-6">Php Form Builder - Form with jQuery Live Validation<br><small>real time validation using jQuery validator plugin</small></h1>
            ...
            <div class="columns is-justify-content-center">
                ...
                <div class="column is-11 is-10-widescreen">
                    <div class="has-text-centered mb-6">
                        <a href="https://www.phpformbuilder.pro/documentation/class-doc.php#javascript-validation-getting-started" class="button is-dark is-small"><strong>Javascript Validation plugin</strong> - documentation here <i class="fas fa-arrow-right ml-2"></i></a>
                    </div>
                    <?php
