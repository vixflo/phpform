...
$form = new Form('dynamic-fields-form-1', 'horizontal', 'novalidate', 'bulma');
...
$form->setCols(0, 12);
$options = array(
    'btnGroupClass' => 'is-flex is-justify-content-flex-end my-3'
);
$form->setOptions($options);
$form->addBtn('button', 'remove-btn', 0, 'Remove Element', 'class=button is-danger remove-element-button, style=visibility:hidden, data-ladda-button=true, data-style=zoom-in', 'add-remove-group');
$form->addBtn('button', 'add-element', 1, 'Add Element', 'class=button is-primary ml-2 add-element-button, data-ladda-button=true', 'add-remove-group');
...
$form->addBtn('submit', 'submit-btn', 1, 'Submit', 'class=button is-primary, data-ladda-button=true, data-style=zoom-in', 'btn-group');
...
<head>
    ...
    <title>Bulma Dynamic fields Form using Ajax - How to create PHP forms easily</title>
    <meta name="description" content="Bulma Form Generator - how to create a Php Form with Ajax dynamic fields using Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bulma-forms/dynamic-fields-form-1.php" />
...
<body>
    ...
    <h1 class="has-text-centered is-size-1 mb-6">Php Form Builder - Form with Ajax Dynamic fields<br><small>click "Add Element" button</small></h1>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function(event) {
            ...
            document.querySelector('.remove-element-button').addEventListener('click', function() {
                let nodes = document.querySelectorAll('#ajax-elements-container .field');
