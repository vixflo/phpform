...
$form = new Form('contact-form-1-modal', 'horizontal', 'novalidate', 'tailwind');
...
<head>
    ...
    <title>Tailwind Modal Contact Form - How to create PHP forms easily</title>
    <meta name="description" content="Tailwind Form Generator - how to create a Modal Contact Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/tailwind-forms/contact-form-1-modal.php" />
...
<body>
    ...
    <h1 class="text-center">Php Form Builder - Tailwind Modal Contact Form</h1>

    <div class="container mx-auto md:px-5 lg:px-10 xl:px-48">
        <div class="grid-cols-1">
            <div class="text-center mb-10">
                <a href="https://www.phpformbuilder.pro/documentation/javascript-plugins.php#modal-example" class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-900 btn-sm"><strong>Modal forms</strong> - documentation here <i class="fas fa-arrow-right ml-4"></i></a>
            </div>
            <?php
            ...
            ?>
            <button data-micromodal-trigger="modal-contact-form-1-modal" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-4 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Contact Us</button>
            <?php
            $form->render();
            ?>
        </div>
