...
$form = new Form('cs-step-plugins-loader', 'horizontal', 'novalidate', 'tailwind');
...
<head>
    ...
    <title>Tailwind Customer Satisfaction Step Form - How to create PHP forms easily</title>
    <meta name="description" content="Tailwind Form Generator - how to create a Customer Satisfaction Step Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/tailwind-forms/customer-satisfaction-step-form.php" />
