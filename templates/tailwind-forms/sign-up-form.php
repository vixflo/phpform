...
if ($currentStep == 1) {
    ...
    $form->centerContent();
    $form->addBtn('submit', 'submit-btn', 1, 'Next <i class="fas fa-arrow-right ml-4" aria-hidden="true"></i>', 'class=btn  btn-primary mt-8, data-ladda-button=true, data-style=zoom-in');
    ...
    $form->centerContent();
    $form->addBtn('submit', 'back-btn', 1, '<i class="fas fa-arrow-left mt-8 mr-4" aria-hidden="true"></i> Back', 'class=btn  btn-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 2, 'Next <i class="fas fa-arrow-right ml-4" aria-hidden="true"></i>', 'class=btn  btn-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    ...
    $form->centerContent();
    $form->addBtn('submit', 'back-btn', 2, '<i class="fas fa-arrow-left mr-4" aria-hidden="true"></i> Back', 'class=btn  btn-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 3, 'Submit <i class="fas fa-arrow-right mt-8 ml-4" aria-hidden="true"></i>', 'class=btn  btn-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
}
...
<head>
    ...
    <title>Tailwind Sign Up Form - How to create PHP forms easily</title>
    <meta name="description" content="Tailwind Form Generator - how to create a Sign Up Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/tailwind-forms/sign-up-form.php" />
