...
$form->setCols(0, 2, 'md');
$form->addBtn('button', 'remove-btn', '', '<i class="fas fa-minus-circle" aria-hidden="true"></i>', 'class=text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 remove-element-button, data-index=' . $index);
