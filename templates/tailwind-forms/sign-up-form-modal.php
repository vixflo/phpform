...
$form = new Form('sign-up-modal-form-1', 'vertical', 'novalidate', 'tailwind');
...
$form->centerContent();
$form->addBtn('reset', 'reset-btn', 1, 'Reset', 'class=text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-4 mb-8 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-900, data-modal-close=modal-target', 'submit-group');
...
<head>
    ...
    <title>Tailwind Sign Up Modal Form - How to create PHP forms easily</title>
    <meta name="description" content="Tailwind Form Generator - how to create a Sign Up Modal Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/tailwind-forms/sign-up-form-modal.php" />
...
<body>
    ...
    <div class="container mx-auto md:px-5 lg:px-10 xl:px-48">
        ...
        <div class="grid-cols-1">
            ...
            ?>
            <button data-micromodal-trigger="modal-sign-up-modal-form-1" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-4 mb-8 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign Up</button>
            <?php
            $form->render();
            ?>
        </div>
