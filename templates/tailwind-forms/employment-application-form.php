...
$form = new Form('employment-application-form', 'horizontal', 'novalidate', 'tailwind');
$form->setMode('development');

$form->startFieldset('Your job', '', 'class=text-2xl dark:text-white my-6');
...
// Portfolio
$form->startFieldset('Your Portfolio', '', 'class=text-2xl dark:text-white my-6');
...
// Contact Information
$form->startFieldset('Your Contact Information', '', 'class=text-2xl dark:text-white my-6');
$form->setCols(3, 4);
...
$form->centerContent();
$form->addBtn('submit', 'my-btn-5', 1, 'Send <span class="fas fa-envelope ml-4"></span>', 'class=text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mt-10 mb-8 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800, data-ladda-button=true, data-style=slide-left');
...
<head>
    ...
    <title>Tailwind Employment Application Form - How to create PHP forms easily</title>
    <meta name="description" content="Tailwind Form Generator - how to create an Employment Application Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/tailwind-forms/employment-application-form.php" />
