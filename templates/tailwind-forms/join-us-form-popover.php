...
$form = new Form('join-us-popover-form', 'horizontal', 'class=m-4, novalidate', 'tailwind');
...
<head>
    ...
    <title>Tailwind Join Us Popover Form - How to create PHP forms easily</title>
    <meta name="description" content="Tailwind Form Generator - how to create a Join Us Popover Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/tailwind-forms/join-us-form-popover.php" />
...
<body>
    ...
    <div class="container mx-auto md:px-5 lg:px-10 xl:px-48">
        ...
        <div class="grid-cols-1">
            ...
            <button type="button" data-popover-trigger="join-us-popover-form" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-4 mb-8 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 text-white">Join Us</button>
            <?php
            $form->render();
            ?>
        </div>
