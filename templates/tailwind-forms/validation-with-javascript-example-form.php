...
$form = new Form('validation-with-jquery-example-form', 'horizontal', 'novalidate', 'tailwind');
$form->setMode('development');

$form->startFieldset('Validation using Native HTML5 fieldtypes / attributes', '', 'class=text-2xl dark:text-white my-6');
...
$form->endFieldset();
$form->startFieldset('Validation using Custom HTML5 attributes (data)', '', 'class=text-2xl dark:text-white my-6');
...
<head>
    ...
    <title>Tailwind Form with jQuery Live Validation - How to create PHP forms easily</title>
    <meta name="description" content="Tailwind Form Generator - how to create form with jQuery live validation using Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/tailwind-forms/validation-with-javascript-example-form.php" />
    ...
    <div class="container mx-auto md:px-5 lg:px-10 xl:px-48">
        <div class="grid-cols-1">
            <div class="text-center mb-10">
                <a href="https://www.phpformbuilder.pro/documentation/class-doc.php#javascript-validation-getting-started" class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-900 btn-sm"><strong>Javascript Validation plugin</strong> - documentation here <i class="fas fa-arrow-right ml-4"></i></a>
            </div>
            <?php
