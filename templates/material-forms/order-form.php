...
$form->startCol(12);
$form->addHeading('Full name', 'label', 'class=');
$form->endCol();
...
$form->startCol(12);
$form->addHeading('Contact Number', 'label', 'class=');
$form->endCol();
...
$form->centerContent();
$form->addBtn('submit', 'submit-btn', 1, 'Proceed <i class="material-icons right" aria-hidden="true">check</i>', 'class=btn waves-effect waves-light, data-ladda-button=true, data-style=zoom-in');
$form->endFieldset();
...
<head>
    ...
    <title>Material Order Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Form Generator - how to create an Material Order Form with Php Form Builder">
...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            M.AutoInit(document.querySelector('#order-form'));
        });
    </script>
