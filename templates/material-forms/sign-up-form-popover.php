...
$form = new Form('sign-up-popover-form-1', 'vertical', 'class=, novalidate', 'material');
...
$form->centerContent();
$form->addBtn('submit', 'submit-btn', 1, 'Sign Up <i class="material-icons right" aria-hidden="true">email</i>', 'class=btn waves-effect waves-light, data-ladda-button=true, data-style=zoom-in');
...
<head>
    ...
    <title>Material Sign Up Popover Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Form Generator - how to create a Sign Up Popover Form with Php Form Builder">
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col m11 l10">
                ...
                <button type="button" data-popover-trigger="sign-up-popover-form-1" class="btn waves-effect waves-light text-white btn-large">Sign Up</button>
                <?php
                $form->render();
                ?>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            M.AutoInit(document.querySelector('#sign-up-popover-form-1'));
        });
    </script>
