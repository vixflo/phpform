...
$form->addIcon('salary-requirements', '<i class="material-icons" aria-hidden="true">attach_money</i>', 'after');
...
$form->centerContent();
$form->addBtn('submit', 'my-btn-5', 1, 'Send <span class="material-icons email right"></span>', 'class=btn waves-effect waves-light, data-ladda-button=true, data-style=slide-left');
...
<head>
    ...
    <title>Material Employment Application Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Form Generator - how to create an Employment Application Form with Php Form Builder">
...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            M.AutoInit(document.querySelector('#employment-application-form'));
        });
    </script>
