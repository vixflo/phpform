...
$form->addOption('subject', 'Support', 'Support', '', 'data-icon=material-icons info left');
$form->addOption('subject', 'Sales', 'Sales', '', 'data-icon=material-icons attach_money left');
$form->addOption('subject', 'Other', 'Other', '', 'data-icon=material-icons info left');
...
<head>
    ...
    <title>Material Dependent fields Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Form Generator - how to create a Form with Dependent fields using Php Form Builder">
...
<body>
    ...
    <h1 class="text-center">Php Form Builder - Material Form with Dependent fields<br><small>Hidden fields shown if special values selected</small></h1>
        ...
        <div class="row">
            ...
            <div class="col m11 l10">
                <div class="center-align">
                    <a href="https://www.phpformbuilder.pro/documentation/javascript-plugins.php#dependent-fields-example" class="btn grey darken-1 waves-effect waves-light btn-small"><strong>Dependent fields</strong> - documentation here <i class="material-icons right">arrow_right</i></a>
                    <p>&nbsp;</p>
                </div>
                <?php
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            M.AutoInit(document.querySelector('#dependent-fields'));
        });
    </script>
