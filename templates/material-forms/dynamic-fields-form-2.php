...
$form->addHtml('<div class="col-md-3"><button type="button" class="btn waves-effect waves-light add-element-button"><i class="material-icons" aria-hidden="true">add_circle</i></button><p>&nbsp;</p></div>');
$form->addHtml('</div>');
...
<head>
    ...
    <title>Material Php Form with Ajax dynamic fields - How to create PHP forms easily</title>
    <meta name="description" content="Material Form Generator - how to load dynamic fields on the fly with Php Form Builder">
...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            M.AutoInit(document.querySelector('#dynamic-fields-form-2'));
        });
    </script>
