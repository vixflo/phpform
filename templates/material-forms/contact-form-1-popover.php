...
<head>
    ...
    <title>Material Popover Contact Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Form Generator - how to create a Popover Contact Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/material-forms/contact-form-1-popover.php" />
...
<body>
    ...
    <h1 class="text-center">Php Form Builder - Material Popover Contact Form</h1>
        ...
        <div class="row">
            ...
            <div class="col m11 l10">
                <div class="center-align">
                    <a href="https://www.phpformbuilder.pro/documentation/javascript-plugins.php#popover-example" class="btn grey darken-1 waves-effect waves-light btn-small"><strong>Popover forms</strong> - documentation here <i class="material-icons right">arrow_right</i></a>
                    <p>&nbsp;</p>
                </div>
                <?php
                ...
                $form->render();
                ?>
                <button data-popover-trigger="contact-form-1-popover" class="btn waves-effect waves-light btn-large">Contact Us</button>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            M.AutoInit(document.querySelector('#contact-form-1-popover'));
        });
    </script>
