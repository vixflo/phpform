...
$form->setCols(0, 2, 'md');
$form->addBtn('button', 'remove-btn', '', '<i class="material-icons" aria-hidden="true">remove_circle</i>', 'class=btn orange darken-1 waves-effect waves-light remove-element-button, data-index=' . $index);
