...
if ($currentStep == 1) {
    ...
    $form = new Form($formId, 'horizontal', 'data-fv-no-auto-submit=true, novalidate', 'material');
    $form->setMode('development');
    $form->addRadio('satisfied-with-company', 'Very Satisfied', 'Very Satisfied', 'data-toggle=true, data-on-icon=material-icons sentiment_very_satisfied, data-off-icon=material-icons radio_button_unchecked, data-on-color=success-o, data-size=bigger');
    $form->addRadio('satisfied-with-company', 'Somewhat satisfied', 'Somewhat satisfied', 'data-toggle=true, data-on-icon=material-icons sentiment_satisfied_alt, data-off-icon=material-icons radio_button_unchecked, data-on-color=primary-o, data-size=bigger');
    $form->addRadio('satisfied-with-company', 'Neither satisfied nor dissatisfied', 'Neither satisfied nor dissatisfied', 'data-toggle=true, data-on-icon=material-icons sentiment_neutral, data-off-icon=material-icons radio_button_unchecked, data-on-color=info-o, data-size=bigger, checked');
    $form->addRadio('satisfied-with-company', 'Somewhat dissatisfied', 'Somewhat dissatisfied', 'data-toggle=true, data-on-icon=material-icons mood_bad, data-off-icon=material-icons radio_button_unchecked, data-on-color=warning-o, data-size=bigger');
    $form->addRadio('satisfied-with-company', 'Very dissatisfied', 'Very dissatisfied', 'data-toggle=true, data-on-icon=material-icons sick, data-off-icon=material-icons radio_button_unchecked, data-on-color=danger-o, data-size=bigger');
    ...
    $form->centerContent();
    $form->addBtn('submit', 'submit-btn', 1, 'Next <i class="material-icons right" aria-hidden="true">arrow_right</i>', 'class=btn btn-small waves-effect waves-light, data-ladda-button=true, data-style=zoom-in');
    $options = [
        'plain'       => 'plain',
        'size'        => 'bigger',
        'animations'  => 'smooth'
    ...
    $form->centerContent();
    $form->addBtn('button', 'back-btn', 2, '<i class="material-icons left" aria-hidden="true">arrow_left</i> Back', 'class=btn btn-small orange darken-1 waves-effect waves-light', 'btns');
    $form->addBtn('submit', 'submit-btn', 2, 'Next <i class="material-icons right" aria-hidden="true">arrow_right</i>', 'class=btn btn-small waves-effect waves-light, data-ladda-button=true, data-style=zoom-in', 'btns');
    ...
    $form->centerContent();
    $form->addBtn('button', 'back-btn', 3, '<i class="material-icons left" aria-hidden="true">arrow_left</i> Back', 'class=btn btn-small orange darken-1 waves-effect waves-light', 'btns');
    $form->addBtn('submit', 'submit-btn', 3, 'Next <i class="material-icons right" aria-hidden="true">arrow_right</i>', 'class=btn btn-small waves-effect waves-light, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
    ...
    $form->centerContent();
    $form->addBtn('button', 'back-btn', 4, '<i class="material-icons left" aria-hidden="true">arrow_left</i> Back', 'class=btn btn-small orange darken-1 waves-effect waves-light', 'btns');
    $form->addBtn('submit', 'submit-btn', 4, 'Next <i class="material-icons right" aria-hidden="true">arrow_right</i>', 'class=btn btn-small waves-effect waves-light, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
    ...
    $form = new Form($formId, 'vertical', 'data-fv-no-auto-submit=true, novalidate', 'material');
    $form->setMode('development');
    ...
    $form->centerContent();
    $form->addBtn('button', 'back-btn', 5, '<i class="material-icons left" aria-hidden="true">arrow_left</i> Back', 'class=btn btn-small orange darken-1 waves-effect waves-light', 'btns');
    $form->addBtn('submit', 'submit-btn', 5, 'Submit <i class="material-icons right" aria-hidden="true">arrow_right</i>', 'class=btn btn-small waves-effect waves-light, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
