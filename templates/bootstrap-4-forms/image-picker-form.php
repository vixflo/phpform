...
$form = new Form('image-picker-form', 'vertical', '', 'bs4');
...
<head>
    ...
    <title>Bootstrap 4 Image picker Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 4 Form Generator - how to create an Image picker Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-4-forms/image-picker-form.php" />
...
<body>
    <h1 class="text-center">Bootstrap 4 Image picker Form<br><small>with Image picker plugin</small></h1>
    <div class="container">
