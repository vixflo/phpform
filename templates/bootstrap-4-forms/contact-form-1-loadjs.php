...
$form = new Form('contact-form-1-loadjs', 'horizontal', 'novalidate', 'bs4');
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a Contact Form with LoadJs and Php Form Builder">
