...
$form = new Form('license-agreement-form', 'vertical', 'novalidate', 'bs4');
$form->setMode('development');
$form->startFieldset('Please read the terms and conditions of the license carefully', '', 'class=text-center mb-4');

if ($hasSignatureError) {
    $signatureErrorMsg = Form::buildAlert('Please add your signature to confirm your agreement', 'bs4', 'danger');
...
$form->addBtn('submit', 'submit-btn', 1, 'Agree <i class="fas fa-check ml-2" aria-hidden="true"></i>', 'class=btn btn-primary, data-ladda-button=true, data-style=zoom-in');
$form->endFieldset();
...
<head>
    ...
    <title>Bootstrap 4 License agreement Form with digital signature - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a License agreement Form with digital signature with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-5-forms/license-agreement.php" />
...
<body>
    ...
    <h1 class="text-center">Php Form Builder - Bootstrap 4 License agreement Form<br><small>with electronic signature</small></h1>
