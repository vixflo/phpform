...
$form = new Form('dependent-fields', 'horizontal', 'novalidate', 'bs4');
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a Form with Dependent fields using Php Form Builder">
