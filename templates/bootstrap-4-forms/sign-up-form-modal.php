...
$form = new Form('sign-up-modal-form-1', 'vertical', 'novalidate', 'bs4');
...
$form->addBtn('submit', 'submit-btn', 1, 'Sign Up <i class="fas fa-envelope ml-2" aria-hidden="true"></i>', 'class=btn btn-primary, data-ladda-button=true, data-style=zoom-in', 'submit-group');
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a Sign Up Modal Form with Php Form Builder">
