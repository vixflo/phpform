...
$form = new Form('date-range-picker-form', 'horizontal', 'novalidate', 'bs4');
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create an Date range picker Form with Php Form Builder">
        ...
        <div class="row justify-content-center">
            <div class="col-md-11 col-lg-10">
                <div class="text-center mb-5">
                    <a href="https://phpformbuilder/documentation/javascript-plugins.php#litepicker-example" class="btn btn-secondary btn-sm"><strong>Litepicker plugin</strong> - documentation here <i class="fas fa-arrow-right ml-2"></i></a>
                </div>
                <?php
