...
$form = new Form('validation-with-jquery-example-form', 'horizontal', 'novalidate', 'bs4');
...
<head>
    ...
    <title>Bootstrap 4 Form with jQuery Live Validation - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 4 Form Generator - how to create form with jQuery live validation using Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-4-forms/validation-with-javascript-example-form.php" />
        ...
        <div class="row justify-content-center">
            <div class="col-md-11 col-lg-10">
                <div class="text-center mb-5">
                    <a href="https://www.phpformbuilder.pro/documentation/class-doc.php#javascript-validation-getting-started" class="btn btn-secondary btn-sm"><strong>Javascript Validation plugin</strong> - documentation here <i class="fas fa-arrow-right ml-2"></i></a>
                </div>
                <?php
