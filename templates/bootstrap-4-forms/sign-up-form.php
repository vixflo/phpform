...
$form = new Form('sign-up-form-1', 'vertical', 'novalidate', 'bs4');
$form->setMode('development');

$form->startFieldset('Create your account', '', 'class=text-center mb-4');
...
$form->centerContent();
$form->addBtn('submit', 'submit-btn', 1, 'Sign Up <i class="fas fa-envelope ml-2" aria-hidden="true"></i>', 'class=btn btn-primary mt-5, data-ladda-button=true, data-style=zoom-in');
$form->endFieldset();
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a Sign Up Form with Php Form Builder">
