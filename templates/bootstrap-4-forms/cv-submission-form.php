...
$form = new Form('cv-submission-form', 'horizontal', 'novalidate', 'bs4');
...
<head>
    ...
    <title>Bootstrap 4 CV Submission Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a CV Submission Form with Php Form Builder">
...
<body>
    <h1 class="text-center">Php Form Builder - Bootstrap 4 CV Submission Form<br><small>with File upload and Rich Text Editor</small></h1>
    <div class="container">
