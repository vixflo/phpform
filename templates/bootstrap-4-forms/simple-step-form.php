...
if ($currentStep == 1) {
    ...
    $formId = 'form-step-1';
    $form = new Form('form-step-1', 'horizontal', 'novalidate', 'bs4');
    ...
    $form->setCols(0, 12);
    $form->centerContent();
    $form->addBtn('submit', 'submit-btn', 1, 'Next <i class="fas fa-arrow-right ml-2" aria-hidden="true"></i>', 'class=btn btn-primary, data-ladda-button=true, data-style=zoom-in');
    ...
    $formId = 'form-step-2';
    $form = new Form('form-step-2', 'horizontal', 'novalidate', 'bs4');
    $form->setMode('development');
    ...
    $form->setCols(0, 12);
    $form->centerContent();
    $form->addBtn('submit', 'back-btn', 1, '<i class="fas fa-arrow-left mr-2" aria-hidden="true"></i> Back', 'class=btn btn-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 2, 'Next <i class="fas fa-arrow-right ml-2" aria-hidden="true"></i>', 'class=btn btn-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    ...
    $formId = 'form-step-3';
    $form = new Form('form-step-3', 'horizontal', 'novalidate', 'bs4');
    $form->setMode('development');
    ...
    $form->setCols(0, 12);
    $form->centerContent();
    $form->addBtn('submit', 'back-btn', 2, '<i class="fas fa-arrow-left mr-2" aria-hidden="true"></i> Back', 'class=btn btn-warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 3, 'Submit <i class="fas fa-arrow-right ml-2" aria-hidden="true"></i>', 'class=btn btn-primary, data-ladda-button=true, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
}
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a simple Step Form with Php Form Builder">
