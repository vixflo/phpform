...
$form = new Form('special-offer-sign-up', 'vertical', 'novalidate', 'bs4');
...
$form->centerContent();
$form->addBtn('submit', 'submit-btn', 1, 'Sign Up <i class="fas fa-arrow-right ml-2" aria-hidden="true"></i>', 'class=btn btn-primary');
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a Special Offer Sign Up with Php Form Builder">
