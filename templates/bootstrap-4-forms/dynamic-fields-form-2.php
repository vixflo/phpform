...
$form->addHtml('<div class="col-md-3"><button type="button" class="btn btn-primary add-element-button"><i class="fas fa-plus-circle" aria-hidden="true"></i></button><p>&nbsp;</p></div>');
$form->addHtml('</div>');
...
<head>
    ...
    <title>Bootstrap 4 Php Form with Ajax dynamic fields - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 4 Form Generator - how to load dynamic fields on the fly with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-4-forms/dynamic-fields-form-2.php" />
