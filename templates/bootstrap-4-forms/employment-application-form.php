...
$form = new Form('employment-application-form', 'horizontal', 'novalidate', 'bs4');
...
$form->centerContent();
$form->addBtn('submit', 'my-btn-5', 1, 'Send <span class="fas fa-envelope ml-2"></span>', 'class=btn btn-primary, data-ladda-button=true, data-style=slide-left');
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create an Employment Application Form with Php Form Builder">
...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-sm-10">
                <h2 class="text-center mb-5">Please fill-in this form to get in touch with us</h2>
                <?php
