...
$form = new Form('switches-form', 'horizontal', 'novalidate', 'bs4');
...
<head>
    ...
    <title>Bootstrap 4 Form with radio and checkboxes switches - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 4 Form Generator - how to create switches from radio buttons and checkboxes">
...
<body>
    <h1 class="text-center">Php Form Builder - Bootstrap 4 Form <br><small>with radio and checkboxes switches</small></h1>
    <div class="container">
