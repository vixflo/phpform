...
$form = new Form('cs-step-plugins-loader', 'horizontal', 'novalidate', 'bs4');
...
$form->addPlugin('formvalidation', '#cs-step-plugins-loader');
?>
<!DOCTYPE html>
<html lang="en-US">
...
<head>
    ...
    <title>Bootstrap 4 Customer Satisfaction Step Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a Customer Satisfaction Step Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-4-forms/customer-satisfaction-step-form.php" />
