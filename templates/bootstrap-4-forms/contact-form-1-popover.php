...
$form = new Form('contact-form-1-popover', 'horizontal', 'novalidate', 'bs4');
...
<head>
    ...
    <title>Bootstrap 4 Popover Contact Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a Popover Contact Form with Php Form Builder">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-4-forms/contact-form-1-popover.php" />
...
<body>
    <h1 class="text-center">Php Form Builder - Bootstrap 4 Popover Contact Form</h1>
    <div class="container">
